...
import 'package:byrahul/pages/event_detail.dart';
import 'package:byrahul/pages/speaker_detail.dart';
...
Widget customCardWidget(
  ...
  return GestureDetector(
    onTap: () {
      if (link != null) {
        context.router.push(EventDetailRoute(id: id));
      } else {
        context.router.push(SpeakerDetailRoute(id: id));
      }
    },
